...
export class AgencyComponent implements OnInit {
  ...
  @Input() numberAddressAgency: string;
  @Input() typeAddressAgency: string;
  @Input() nameAddressAgency: string;
  @Input() complementAddressAgency: string;
  @Input() zipAddressAgency: string;
  @Input() cityAddressAgency: string;
